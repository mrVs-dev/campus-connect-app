    ...
    <div className={cn('relative h-12 w-12', className)} {...props}>
      ...
      >
        <g transform="translate(25, 60) scale(1.2)">
          ...
          <text x="50" y="85" fontFamily="Arial, Helvetica, sans-serif" fontSize="40" fill="#000000">y</text>
          <text x="70" y="85" fontFamily="Arial, Helvetica, sans-serif" fontSize="40" fill="#000000">p</text>
          <text x="95" y="85" fontFamily="Arial, Helvetica, sans-serif" fontSize="40" fill="#000000">f</text>
        </g>
      </svg>
    </div>
  );
